...
const Contact = () => {
  ...
  return (
    <section id="contact" className="bg-moduno-lightgray section-padding">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-3xl font-bold inline-block heading-underline mx-auto after:left-1/2 after:-translate-x-1/2">Get In Touch</h2>
          ...
          <div>
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700">Moduno PVT Ltd, Jaffna, Sri Lanka</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700">+94 74 214 5537</p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-10">
              ...
              <div className="flex gap-4">
                <a href="#" className="bg-moduno-navy text-white p-3 rounded-full hover:bg-moduno-yellow hover:text-moduno-navy transition-colors">
